...
export const backfillEventAnalyticsCounters = functions.https.onCall(async (data, context) => {
    ...
    let query = db.collection('events').orderBy(FieldPath.documentId()).limit(limit);
