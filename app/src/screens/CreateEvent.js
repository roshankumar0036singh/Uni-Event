    ...
    const handleCreate = async () => {
        ...
        try {
            ...
            const eventData = {
                ...
                isPaid, price: isPaid ? price : '0', upiId: isPaid ? upiId : null,
                registrationLink,
    ...
    const renderDateInput = (label, date, setDate, showPicker, setShowPicker, isStart) => {
            ...
            return (
                <View style={[styles.webDateContainer, { flex: 1, minWidth: 0 }]}>
                    <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 8, gap: 6 }}>
                        ...
                        <Text style={{ fontSize: 14, fontWeight: '600', color: theme.colors.textSecondary }}>{label}</Text>
                    </View>
                    <input
                        type="datetime-local"
                        value={iso}
        ...
        return (
            <View style={{ flex: 1 }}>
                ...
                <TouchableOpacity onPress={() => { setDateMode('date'); setShowPicker(true); }} style={styles.dateCard}>
            ...
            <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.section}>
                    ...
                    <View style={[styles.row, { justifyContent: 'space-between' }]}>
                        <View style={{ width: '48%' }}>
                            {renderDateInput("Starts", startDate, setStartDate, showStartPicker, setShowStartPicker, true)}
                        </View>
                        <View style={{ width: '48%' }}>
                    ...
                    <View style={styles.segmentContainer}>
                        ...
                        >
                            <Text style={[styles.segmentText, eventMode === 'offline' && styles.segmentTextActive]}>Offline</Text>
                        </TouchableOpacity>
                        <TouchableOpacity
                            style={[styles.segment, eventMode === 'online' && styles.segmentActive]}
                            onPress={() => setEventMode('online')}
                        >
                            <Text style={[styles.segmentText, eventMode === 'online' && styles.segmentTextActive]}>Online</Text>
                        </TouchableOpacity>
                    </View>
                    ...
                    {eventMode === 'online' ? (
                        <View style={{ marginTop: 15 }}>
                            ...
                            />
                            <TouchableOpacity style={styles.gmeetBtn} onPress={() => promptAsync()} disabled={!request}>
                ...
                <View style={styles.section}>
                    ...
                    <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.chipScroll}>
                        {BRANCHES.map(b => (
                            ...
                            >
                                <Text style={[styles.chipText, targetBranches.includes(b) && styles.chipTextActive]}>{b}</Text>
                            </TouchableOpacity>
                        ))}
                    </ScrollView>
                    ...
                    <View style={[styles.row, { flexWrap: 'wrap', gap: 10 }]}>
                        {YEARS.map(y => (
                            ...
                            >
                                <Text style={[styles.yearText, targetYears.includes(y) && styles.yearTextActive]}>{y}st Year</Text>
                            </TouchableOpacity>
                        ))}
                    </View>
                </View>
                ...
                <View style={[styles.section, isPaid && styles.highlightSection]}>
                    <View style={[styles.row, { justifyContent: 'space-between', alignItems: 'center' }]}>
                        <View>
                            ...
                            <Text style={{ color: theme.colors.textSecondary, fontSize: 12 }}>Is this a paid event?</Text>
                        </View>
                        <Switch
                            value={isPaid}
...
const getStyles = (theme) => StyleSheet.create({
    ...
    bannerPicker: {
        ...
        marginBottom: 24, overflow: 'hidden', borderStyle: 'dashed', borderWidth: 1, borderColor: theme.colors.border,
        justifyContent: 'center', alignItems: 'center'
    },
    bannerImage: { width: '100%', height: '100%' },
    placeholder: { alignItems: 'center', gap: 8 },
    placeholderText: { color: theme.colors.textSecondary, fontWeight: '600' },
    editIcon: { position: 'absolute', bottom: 10, right: 10, backgroundColor: 'rgba(0,0,0,0.5)', padding: 8, borderRadius: 20 },
    ...
    // Segment
    segmentContainer: {
        flexDirection: 'row', backgroundColor: theme.colors.surface, borderRadius: 12, padding: 4
    },
    ...
    yearChip: {
        ...
        backgroundColor: theme.colors.surface, borderWidth: 1, borderColor: theme.colors.border, flex: 1, minWidth: '45%', alignItems: 'center'
    },
    ...
    highlightSection: {
        ...
        borderRadius: 16, padding: 15, borderWidth: 1, borderColor: theme.colors.border
    },
